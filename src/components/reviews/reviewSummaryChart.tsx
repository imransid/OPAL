...
export default function ReviewSummaryChart({ reviews }: Props) {
  const rating =
    reviews.length > 0 ? Math.trunc(reviews.reduce((s, r) => s + r.rating, 0) / reviews.length) : 0;
      ...
      <div className="row">
        <div className="col-12 col-lg-5">
          <div className="p-4 mb-4">
            ...
            <button type="button" className="btn btn-dark w-100 mb-0">
              Write a review
            </button>
          </div>
        </div>
