...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-dark text-white pt-5 pb-3 mt-auto"
        ...
        <div className="row g-4 g-lg-5 pb-4 pb-lg-5 border-bottom border-secondary border-opacity-25 align-items-start">
          ...
          <div className="col-12 col-lg-3">
            <a
              ...
              style={{ fontSize: '1.125rem', fontWeight: 500, letterSpacing: '0.22em', textTransform: 'uppercase' }}
            >
              OPAL
            </a>
            <p className="text-white-50 small mb-0 lh-lg" style={{ maxWidth: '20rem' }}>
              Fashion and tech, curated with care. Secure checkout, thoughtful packaging, fast delivery.
            </p>
          </div>

          {/* Shop */}
          <div className="col-6 col-md col-lg-2">
            <h6 className="text-uppercase small fw-medium mb-3 text-white-50" style={{ letterSpacing: '0.2em', fontSize: '0.65rem' }}>
              Shop
            </h6>
          ...
          <div className="col-12 col-lg-5">
            <div className="footer-newsletter-glass rounded-3 p-4">
              <h6 className="text-uppercase small fw-medium mb-2 text-white-50" style={{ letterSpacing: '0.2em', fontSize: '0.65rem' }}>
                Newsletter
              </h6>
        ...
        <div className="row align-items-center pt-3">
          <div className="col-12 col-md-6 text-center text-md-start mb-2 mb-md-0">
            <p className="small text-white-50 mb-0">
              © {year} <span className="text-white fw-medium" style={{ letterSpacing: '0.12em' }}>OPAL</span>. All rights reserved.
            </p>
          </div>
