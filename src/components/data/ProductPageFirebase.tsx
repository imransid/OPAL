  ...
  return (
    <div className="container py-4 py-md-5 px-3 px-md-4">
      ...
      <ProductOverviewGrid
        ...
        videoPoster={firstString(
          product.videoPoster,
          (product as unknown as Record<string, unknown>).video_poster,
          (product as unknown as Record<string, unknown>).videoThumbnail,
          (product as unknown as Record<string, unknown>).video_thumbnail
        )}
